...
namespace OSCiR.Migrations
{
    ...
    [Migration("20190308155117_UserRenameComments")]
    partial class UserRenameComments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CMDB.Areas.CI.Model.ConfigItemRelationshipEntity", b =>
                {
                    ...
                    b.Property<Guid>("ClassRelationshipEntityId");
                    ...
                    b.HasIndex("ClassRelationshipEntityId");

                    b.HasIndex("TargetConfigItemEntityId");

                    b.HasIndex("SourceConfigItemEntityId", "TargetConfigItemEntityId", "ClassRelationshipEntityId")
                        .IsUnique();
            ...
            modelBuilder.Entity("CMDB.Areas.CI.Model.ConfigItemRelationshipEntity", b =>
                {
                    b.HasOne("CMDB.Areas.Admin.Class.Model.ClassRelationshipEntity", "ClassRelationship")
                        .WithMany()
                        .HasForeignKey("ClassRelationshipEntityId")
                        .OnDelete(DeleteBehavior.Cascade);
